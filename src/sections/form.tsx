        ...
        <>
            <div className={'grid grid-cols-2 md:px-[200px] px-[50px] md:pt-[200px] pt-6 pb-20'}>
                <div className={'md:block hidden'}>
                    <div className="grid grid-cols-3 gap-1">
                        <div className="col-span-2">
                            <Image src={FirstChocolateProduct} width={1000} height={300} alt={'Making Chocolates'} className={'w-full h-[300px] object-cover'} />
                        </div>
                        <div>
                            <Image src={SecondChocolateProduct} width={1000} height={300} alt={'Making Chocolates'} className={'w-full h-[300px] object-cover'} />
                        </div>
                        <div>
                            <Image src={ThirdChocolateProduct} width={1000} height={300} alt={'Making Chocolates'} className={'w-full h-full object-cover'} />
                        </div>
                    </div>
                </div>
                ...
                <div className={'md:ml-20 ml-0 md:col-span-1 col-span-2'}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className={'p-10 md:mt-10 mt-5 bg-white border border-gray-200 rounded-lg shadow w-full'}>
