            ...
            <div className={'md:px-[200px] px-[50px] md:pt-20 pt-3.5 flex md:flex-row flex-col justify-between'}>
                ...
                <div className={'md:w-[650px] w-full text-center'}>
                    ...
                    <p className={'md:text-xl text-xs font-sans  mt-10 text-justify'}>
                        ...
                        meticulosamente elaboradas con los mejores granos de cacao, seleccionados de las regiones más
                        ...
                        Además, nos enorgullece ofrecer una variedad de presentaciones que satisfacen todos los gustos y
                        ocasiones. ¿Buscas un regalo único para un ser querido? Nuestras elegantes cajas de trufas son
                        la opción perfecta.
                    </p>
                    <button
